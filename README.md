Convert.py is used to convert the csv data into sql tables by creating a database called "database" (Note: this step is optional because database is already loaded with all the tables.
